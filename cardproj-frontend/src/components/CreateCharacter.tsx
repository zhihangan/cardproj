...
type Score = {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-blue-900 p-4 text-white">
        {!showResults ? (
            <div
            className={`w-full max-w-md p-6 bg-white text-black rounded-lg shadow-md transform transition-opacity duration-500 ${
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <button
                    ...
                    className="col-span-1 bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-300"
                >
                    {answer.text}
                </button>
                ))}
            ...
            <p className="text-lg text-gray-700">{getResult()}</p>
            </div>
        )}
        </div>
    );
